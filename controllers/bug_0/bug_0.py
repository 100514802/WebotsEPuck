...
while robot.step(timestep) != -1 and not target_reached: #El bucle acaba al alcanzar la meta
    ...
    if state == 0: #Avanza hacia el objetivo
        ...
        if psValues[7]>80.0 or psValues[0]>80.0: #Si el obstaculo esta delante
            ...
            state = 2
        elif psValues[2]<200.0: #Cuando acabo de recorrer uno de los contorno trato de orientar a objetivo
            print('Oriento destino!')
            state = 0 #Este estado se mantendrá hasta que encuentre de nuevo un obstaculo en el camino
    ...
    if robot_pos[0] > x_goal and robot_pos[1] > y_goal:
        ...
        if not message_displayed:
            ...
            print(f"Objetivo alcanzado! Algoritmo Bug 0. Tiempo transcurrido: {elapsed_time:.2f} segundos.")         
